...
100 users with average 10 friends means total_friendships = 100 \* 10 = 1000
then we need half of that because the direction of the graph is bidirectional
so (friend1, friend2) is the same as (friend2, friend1) so half the list is of
no use. We end up with 500 calls to add_friendship()

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

percentage of other users in user's extended social network: %0.005
